class NewsPaperRunner {
    ...
    public static void main(String[] args) {
        ...
        store.updateLangByName("The Times of India", "English");
        ...
        NewsPaper replaceNewsPaper = new NewsPaper("English", "High", 6.0, 25,
